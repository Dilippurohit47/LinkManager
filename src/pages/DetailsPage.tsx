...
const DetailsPage = () => {
  return (
    <div className="min-h-[80vh]  max-md:px-2 py-3    grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3  gap-10    lg:gap-1 justify-items-center justify-self-center   h-full w-full">
      <DetailBox
        img={"/room.png"}
        desc={
